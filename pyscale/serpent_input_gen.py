...
#####################################################################################################
relative_path = input("Path to SCALE runs containing the .stdcmp_m1 files? ")

beta_directory = relative_path
...
with open("serpent_runner_{}.sh".format(reactor), "w", newline='\n') as f2:
    ...
    x = 0
    for i in range(0, len(eff)):
        f2.write("cd /mnt/c/Users/vicen/Desktop/SCALE_beta_decay/Serpent/Depleted/{}/{}/2D_Unit_Cell_{}/ \n".format(
